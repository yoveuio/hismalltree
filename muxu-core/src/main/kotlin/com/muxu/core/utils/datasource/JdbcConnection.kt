...
interface JdbcConnection {
    ...
    private fun getSchemaCatalog(metaData: DatabaseMetaData, dbName: String?): List<CatalogTreeDTO> {
    ...
    private fun getTableCatalog(metaData: DatabaseMetaData, catalog: String?, schema: String?): List<CatalogTreeDTO> {
